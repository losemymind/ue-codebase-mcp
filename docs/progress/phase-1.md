...
The backup/uninstall path has not yet been executed because no backup directory or removal request was supplied. Production database grants/TLS, retrieval and request-audit assembly, object storage, immutable control-plane image approval and the fixed-device TLS/service rehearsal remain open. P1-18 is still in progress and Phase 2 remains frozen.
